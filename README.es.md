...
3. **Arquetipos Tácticos:** El algoritmo de agrupamiento identificó cuatro roles distintos. Cabe destacar que el **Grupo 2 (Progresivos de Élite - 188 jugadores)** engloba a los principales directores de la salida de balón, quienes promedian 5.6 pases progresivos por 90 minutos, mientras que el **Grupo 3 (Destructores - 173 jugadores)** aísla a defensores reactivos y de alto volumen de acciones que muestran una seguridad en el pase notablemente inferior (78%).
